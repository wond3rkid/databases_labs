...
<form method="post">
    <div class="form-group">
        ...
        <input type="text" name="first_name" id="first_name" value="<?= htmlspecialchars($student['first_name']); ?>"
               required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="date" name="birth_day" id="birth_day" value="<?= htmlspecialchars($student['birth_day']); ?>"
               required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.1" name="gpa" id="gpa" value="<?= htmlspecialchars($student['gpa']); ?>" min="0"
               max="5" required>
    </div>
    <div class="form-group">
        <label for="group_id">ID группы:</label>
        <input type="number" name="group_id" id="group_id" value="<?= htmlspecialchars($student['group_id']); ?>"
               min="1" required>
    </div>
    <br>
